 ...
 */
final class Version20230130124838 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE contract_charge (contract_id INT NOT NULL, charge_id INT NOT NULL, INDEX IDX_692B41792576E0FD (contract_id), INDEX IDX_692B417955284914 (charge_id), PRIMARY KEY(contract_id, charge_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('ALTER TABLE contract_charge ADD CONSTRAINT FK_692B41792576E0FD FOREIGN KEY (contract_id) REFERENCES contract (id) ON UPDATE NO ACTION ON DELETE CASCADE');
        $this->addSql('ALTER TABLE contract_charge ADD CONSTRAINT FK_692B417955284914 FOREIGN KEY (charge_id) REFERENCES charge (id) ON UPDATE NO ACTION ON DELETE CASCADE');
